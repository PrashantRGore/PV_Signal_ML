...
**Period assessed:** 2025/01/01:2025/03/31  
...
## 3. Quantitative evidence – FAERS period (2025/01/01:2025/03/31)
...
Methods parameters (thresholds, input files) are captured in the model run metadata and methods artifact (for example, `methods_2c57356662cc4d53845bb5615f295541.json` where available).
...
- MLflow tracking: run_id 2c57356662cc4d53845bb5615f295541, experiment pv-signal-ml (local file-based tracking).[web:126][web:135]
